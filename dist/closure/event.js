 ...
 */
goog.require('cohesive.isString');
goog.require('cohesive.isArray');
goog.require('cohesive.extend');
goog.provide('cohesive.event');
goog.provide('cohesive.event.listen');
goog.provide('cohesive.event.unlisten');
goog.provide('cohesive.event.listenOnce');
goog.provide('cohesive.event.Event');
goog.provide('cohesive.event.EventTarget');
...
cohesive.event.listenOnce = listenOnce;
...
cohesive.event.EventTarget = EventTarget;
